...
return require('packer').startup(function(use)
                ...
                settings = {
                    yaml = {
                        ...
                        schemas = {
                            ...
                            "virtualservice.yaml", "vscv.yaml", "gw.yaml",
                        },
                    },
                }
            }
    ...
    use { 'williamboman/mason-lspconfig.nvim',
        config = function()
            ...
            mason_lsp.setup({
                ensure_installed = { "gopls", "golangci_lint", "tsserver", "rust_analyzer", "yamlls", "dockerls",
                    "sumneko_lua", "bashls", "jsonls" }
            })
        end
    }
    ...
    use {
        ...
        config = function()
            require 'nvim-treesitter.configs'.setup {
                ...
                ensure_installed = { "go", "json", "yaml", "lua", "rust", "dockerfile", "regex", "tsx", "toml", "css",
                    "javascript", "html" },
